    ...
    if (isNeutron)
    {
        if (plot_and_fit_MomRes)
        {
            ...
            if (momRes_test)
            {
                ...
                { // if Calculate_momResS2=true => load everything from momResS1 files
                ...
                { // if Calculate_momResS2=false => load everything from either momResS1 or momResS2
                    if (Run_with_momResS2)
                    { // if Calculate_momResS2=false && Run_with_momResS2=true => load correction from momResS1 and smearing from momResS2
                        /* Load neutron correction fit parameters (correction factor from momResS1 reco fits!) */
                        ReadResDataParam((MomentumResolutionDirectory + "Res_data_-_" + SampleName + "/Neutron_momResS1_fit_param_-_" +
                                          SampleName + ".par")
                                             .c_str(),
                    ...
                    { // if Calculate_momResS2=false and Run_with_momResS2=false => load both correction and smearing from momResS1
                        /* Load neutron correction fit parameters (correction factor from momResS1 reco fits!) */
                        ReadResDataParam((MomentumResolutionDirectory + "Res_data_-_" + SampleName + "/Neutron_momResS1_fit_param_-_" +
                                          SampleName + ".par")
                                             .c_str(),
        ...
        { // if plot_and_fit_MomRes=false => Calculate_momResS2=false !!!
            SetSmearAndCorrModes(SmearM, CorrM);

            if (Run_with_momResS2)
            { // if Run_with_momResS2=true => load correction from momResS1 and smearing from momResS2
                                         ...
                                         const bool &FitDebugging)
{
            ...
            if (VaryingDelta)
            {
                if (MomentumType == "truth")
                {
                    if (beamE == 5.98636)
                    {
                        ...
                        {
                            if ((SliceLowerLim >= 0.40) && (SliceLowerLim < 0.60))
                            { // 0.4-0.65
                                Delta = delta * 5;
                            }
                            else if ((SliceLowerLim >= 0.60) && (SliceLowerLim < 1.00))
                            { // 0.65-1.05
                                Delta = delta * 2;
                            }
                            else if ((SliceLowerLim >= 1.00) && (SliceLowerLim < 1.70))
                            { // 1.05-1.70
                                Delta = delta * 1;
                            }
                            else if ((SliceLowerLim >= 1.70) && (SliceLowerLim < 2.25))
                            { // 1.70-2.30
                                Delta = delta * 2;
                            }
                            else if ((SliceLowerLim >= 2.25) && (SliceLowerLim < 2.55))
                            { // 2.30-2.60
                                Delta = delta * 3;
                            }
                            else if ((SliceLowerLim >= 2.55) && (SliceLowerLim < 2.95))
                            { // 2.60-3.00
                                Delta = delta * 4;
                            }
                            else if ((SliceLowerLim >= 2.95) && (SliceLowerLim < 3.25))
                            { // 3.00-3.30
                                Delta = delta * 6;
                            }
                            else if (SliceLowerLim >= 3.25)
                            { // 3.00-SliceUpperMomLim
                                Delta = SliceUpperMomLim - SliceLowerLim;
                            }
                        }
                        else if (SampleName == "C12x4_simulation_G18_Q204_6GeV")
                        { // Slices by option 2
                            if ((SliceLowerLim >= 0.40) && (SliceLowerLim < 0.60))
                            { // 0.4-0.65
                                Delta = delta * 5;
                            }
                            else if ((SliceLowerLim >= 0.60) && (SliceLowerLim < 1.10))
                            { // 0.65-1.15
                                Delta = delta * 2;
                            }
                            else if ((SliceLowerLim >= 1.10) && (SliceLowerLim < 1.55))
                            { // 1.15-1.55
                                Delta = delta * 1;
                            }
                            else if ((SliceLowerLim >= 1.55) && (SliceLowerLim < 2.25))
                            { // 1.55-2.25
                                Delta = delta * 2;
                            }
                            else if ((SliceLowerLim >= 2.25) && (SliceLowerLim < 2.55))
                            ...
                            else if ((SliceLowerLim >= 2.55) && (SliceLowerLim < 2.75))
                            { // 2.55-2.75
                                Delta = delta * 4;
                            }
                            else if ((SliceLowerLim >= 2.75) && (SliceLowerLim < 3.00))
                            { // 2.75-3.00
                                Delta = delta * 5;
                            }
                            else if ((SliceLowerLim >= 3.00) && (SliceLowerLim < 3.50))
                            { // 3.00-3.50
                                Delta = delta * 10;
                            }
                            else if (SliceLowerLim >= 3.50)
                            { // 3.00-SliceUpperMomLim
                                Delta = SliceUpperMomLim - SliceLowerLim;
                            }
                        }
                    ...
                    {
                        if ((SliceLowerLim >= 0.40) && (SliceLowerLim < 0.50))
                        { // 0.4-0.55
                            Delta = delta * 3;
                        }
                        else if ((SliceLowerLim >= 0.50) && (SliceLowerLim < 1.10))
                        { // 0.55-1.15
                            Delta = delta * 2;
                        }
                        else if ((SliceLowerLim >= 1.10) && (SliceLowerLim < 1.25))
                        { // 1.15-1.30
                            Delta = delta * 3;
                        }
                        else if (SliceLowerLim >= 1.25)
                        { // 1.30-beamE
                ...
                else if (MomentumType == "reco")
                {
                    if (beamE == 5.98636)
                    {
                        if (SampleName == "C12x4_simulation_G18_Q204_6GeV")
                        {
                            ...
                            else if ((SliceLowerLim >= 0.60) && (SliceLowerLim < 0.90))
                            { // 0.60-0.90
                                Delta = delta * 2;
                            }
                            else if ((SliceLowerLim >= 0.90) && (SliceLowerLim < 1.60))
                            { // 0.90-1.60
                                Delta = delta * 1;
                            }
                            else if ((SliceLowerLim >= 1.60) && (SliceLowerLim < 2.10))
                            { // 1.60-2.10
                                Delta = delta * 2;
                            }
                            else if ((SliceLowerLim >= 2.10) && (SliceLowerLim < 2.40))
                            { // 2.10-2.40
                                Delta = delta * 3;
                            }
                            else if ((SliceLowerLim >= 2.40) && (SliceLowerLim < 2.65))
                            { // 2.40-2.65
                                Delta = delta * 5;
                            }
                            else if ((SliceLowerLim >= 2.65) && (SliceLowerLim < 3.05))
                            { // 2.65-3.05
                                Delta = delta * 8;
                            }
                            else if (SliceLowerLim >= 3.05)
                            { // 3.05-SliceUpperMomLim
                                Delta = SliceUpperMomLim - SliceLowerLim;
                            }
                        }
                        else
    ...
    if (TLLimitsPrintOut && TLLimitsPrintOutAndExit && (MomentumType == "truth"))
    {
        exit(0);
    }

    if (RecoLimitsPrintOut && RecoLimitsPrintOutAndExit && (MomentumType == "reco"))
    {
        exit(0);
    }
                                             ...
                                             vector<int> &FittedSlices0, int &NumberOfSlices0)
{
    ...
    for (int i = 0; i < NumberOfSlices0; i++)
    {
        ...
        { // Fit only the non-empty histograms
            cout << "\n\n";

            double FitUlim, FitLlim;

            if (momResTestMode)
            {                                // In smear & shift test mode
                                    ...
                                    vector<vector<double>> &FitParamResults)
{
    ...
    {
        x_1_Offset_Legend = x_1_Offset_Legend * 2;
    }
    ...
    if (PolynomialDegree == 1)
    {
        FitParam->AddText(("A = " + to_string_with_precision(FitParamResults.at(0).at(0), 4) +
                           " #pm " + to_string_with_precision(FitParamResults.at(1).at(0), 4))
                              .c_str());
        FitParam->AddText(("B = " + to_string_with_precision(FitParamResults.at(0).at(1), 4) +
                           " #pm " + to_string_with_precision(FitParamResults.at(1).at(1), 4))
                              .c_str());
    }
    else if (PolynomialDegree == 2)
    {
        ...
        FitParam->AddText(("C = " + to_string_with_precision(FitParamResults.at(0).at(2), 4) +
                           " #pm " + to_string_with_precision(FitParamResults.at(1).at(2), 4))
                              .c_str());
    }
    else if (PolynomialDegree == 3)
    {
        ...
        FitParam->AddText(("D = " + to_string_with_precision(FitParamResults.at(0).at(3), 4) +
                           " #pm " + to_string_with_precision(FitParamResults.at(1).at(3), 4))
                              .c_str());
    }
    ...
    if (findSubstring(parameter, MomentumType))
    {
        ...
        if (!findSubstring(parameter, "error") && !findSubstring(parameter, "FitGoodness"))
        {
            if (Loaded_FitVarResults.size() != (PolynomialDegree + 1))
            {
                ...
                for (int i = 0; i < Loaded_FitVarResults.size(); i++)
                {
                    cout << Loaded_FitVarResults.at(i) << "\n";
                }
                cout << "\nExiting...\n\n", exit(0);
            }
        }
        ...
        if (findSubstring(parameter, "error") && !findSubstring(parameter, "FitGoodness"))
        {
            if (Loaded_FitVarResultsErrors.size() != (PolynomialDegree + 1))
            {
                ...
                cout << "expected size (= PolynomialDegree) = " << PolynomialDegree << "\n";
                cout << "Loaded_FitVarResultsErrors elements:\n";
                for (int i = 0; i < Loaded_FitVarResultsErrors.size(); i++)
                {
                    cout << Loaded_FitVarResultsErrors.at(i) << "\n";
                }
                cout << "\nExiting...\n\n", exit(0);
            }
        }
        ...
        if (!findSubstring(parameter, "error") && findSubstring(parameter, "FitGoodness"))
        {
            if (Loaded_FitVarResultsGoodness.size() != 2)
            {
                ...
                cout << "Loaded_FitVarResultsErrors elements:\n";
                for (int i = 0; i < Loaded_FitVarResultsGoodness.size(); i++)
                {
                    cout << Loaded_FitVarResultsGoodness.at(i) << "\n";
                }
                cout << "\nExiting...\n\n", exit(0);
            }
        }
                                    ...
                                    vector<vector<double>> &Loading_Dest)
{
    ...
    if (findSubstring(parameter, MomentumType))
    {
        ...
        if (PrintOutAndExit && (PolynomialDegree == PolynomialDeg2Print) && (MomentumType == MomentumType2Print))
        {
            exit(0);
        }
...
double MomentumResolution::PSmear(const bool &apply_nucleon_SmearAndCorr, const double &Momentum)
{
    ...
    else
    {
        ...
        if (SmearMode == "slices")
        {
            ...
            if (Momentum < SliceUpperMomLim)
            { // NOTE: changed according to upper neutron mom. th.

...
//<editor-fold desc="histPlotter2D function (regular)">
void hPlot2D::histPlotter2D(const std::string &SampleName, TCanvas *Histogram2DCanvas, TH2D *Histogram2D, TList *Histogram_list, TFile *Histogram_OutPDF, std::string Histogram2DSaveNameDir,
...
void hPlot2D::hDrawAndSave(const std::string &SampleName, TCanvas *h2DCanvas, TList *hList, TFile *Histogram_OutPDF, bool showStats) {
...
void hPlot2D::hDrawAndSave(const std::string &SampleName, TCanvas *h2DCanvas, TList *hList, TFile *Histogram_OutPDF, TF1 *Beta_function1, TF1 *Beta_function2,
...
void hPlot2D::hDrawAndSave(const std::string &SampleName, TCanvas *h2DCanvas, TList *hList, TFile *Histogram_OutPDF, TF1 *Beta_function1, std::string particle1, bool showStats, bool plot_legend) {
...
void hPlot2D::hDrawAndSave(const std::string &SampleName, TCanvas *h2DCanvas, TList *hList, TFile *Histogram_OutPDF, TF1 *Beta_function1, std::string particle1, TF1 *Beta_function2,

...
public:
    ...
    void setdebug_fileName(TString db_fileName) {
        debug_fileName = db_fileName;
    }

    void set_hit_map_ref_fileName(TString db_fileName) {
        hit_map_ref_Out_filename = db_fileName;
    }
    ...
    void setDCEdgeCuts(bool flag = true) {
        f_DCEdgeCuts = flag;
    };

    void set_e_DCEdgeCuts(bool flag = true) {
        f_e_DCEdgeCuts = flag;
    };

    void setEcalEdgeCuts(bool flag = true) {
        f_ecalEdgeCuts = flag;
    };

    void setPidCuts(bool flag = true) {
        f_pidCuts = flag;
    };

    void set_e_VertexCuts(bool flag = true) {
        f_e_vertexCuts = flag;
    };

    void setVertexCuts(bool flag = true) {
        f_vertexCuts = flag;
    };

    void setVertexCorrCuts(bool flag = true) {
        f_corr_vertexCuts = flag;
    };
    ...
    std::vector<region_part_ptr> getLeadSRC() {
        return lead_proton;
    };

    std::vector<region_part_ptr> getRecoilSRC() {
        return recoil_proton;
    };
    ...
    double getEcalSFUpperCut() {
        return SF_max_cut;
    }; // My addition

    double getEcalSFLowerCut() {
        return SF_min_cut;
    }; // My addition

    double getDCEdgeCuts() {
        return dc_edge_cut;
    }; // My addition

    double getEcalEdgeCuts() {
        return ecal_edge_cut;
    }; // My addition

    void setNpheCuts(bool flag = true) {
        f_NpheCuts = flag;
    }; // My addition

    double getNpheCuts() {
        return htcc_Nphe_cut;
    }; // My addition

    double getNeutronMomentumCut() {
        return Neutron_Momentum_cut;
    }; // My addition

    double getNeutralBetaCut() {
        return FD_Neutral_Beta_cut;
    }; // My addition

    double getNeutralBetaCutMean() {
        return FD_Neutral_Beta_Mean;
    }; // My addition
    ...
    void addToAllParticles(region_part_ptr p) {
...
private:
    ...
    TH2D * pid_cd_debug = new
    TH2D("pid_cd_debug", "PID Uncut CD", 100, 0, 3, 100, 0, 1.2);
    TH2D * pid_fd_debug = new
    TH2D("pid_fd_debug", "PID Uncut FD", 100, 0, 5, 100, 0, 1.2);

    TH2D * sf_v_ecalIN_debug = new
    TH2D("sf_v_ecalIN_debug", "", 100, 0, 30, 100, 0, .4);
    TH2D * sf_w_ecalIN_debug = new
    TH2D("sf_w_ecalIN_debug", "", 100, 0, 30, 100, 0, .4);

    TH2D * sf_v_ecalOUT_debug = new
    TH2D("sf_v_ecalOUT_debug", "", 100, 0, 30, 100, 0, .4);
    TH2D * sf_w_ecalOUT_debug = new
    TH2D("sf_w_ecalOUT_debug", "", 100, 0, 30, 100, 0, .4);

    TH2D * sf_v_pcal_debug = new
    TH2D("sf_v_pcal_debug", "", 100, 0, 30, 100, 0, .4);
    TH2D * sf_w_pcal_debug = new
    TH2D("sf_w_pcal_debug", "", 100, 0, 30, 100, 0, .4);

    TH2D * sf_v_ecalIN_a_debug = new
    TH2D("sf_v_ecalIN_a_debug", "", 100, 0, 30, 100, 0, .4);
    TH2D * sf_w_ecalIN_a_debug = new
    TH2D("sf_w_ecalIN_a_debug", "", 100, 0, 30, 100, 0, .4);

    TH2D * sf_v_ecalOUT_a_debug = new
    TH2D("sf_v_ecalOUT_a_debug", "", 100, 0, 30, 100, 0, .4);
    TH2D * sf_w_ecalOUT_a_debug = new
    TH2D("sf_w_ecalOUT_a_debug", "", 100, 0, 30, 100, 0, .4);

    TH2D * sf_v_pcal_a_debug = new
    TH2D("sf_v_pcal_a_debug", "", 100, 0, 30, 100, 0, .4);
    TH2D * sf_w_pcal_a_debug = new
    TH2D("sf_w_pcal_a_debug", "", 100, 0, 30, 100, 0, .4);

    TH2D * pid_proton_fd_debug = new
    TH2D("pid_proton_fd_debug", "PID Cut Proton FD", 100, 0, 5, 100, 0, 1.2);
    TH2D * pid_proton_cd_debug = new
    TH2D("pid_proton_cd_debug", "PID Cut Proton CD", 100, 0, 5, 100, 0, 1.2);
    TH2D * pid_piplus_fd_debug = new
    TH2D("pid_piplus_fd_debug", "PID Cut #pi + FD", 100, 0, 5, 100, 0, 1.2);
    TH2D * pid_piplus_cd_debug = new
    TH2D("pid_piplus_cd_debug", "PID Cut #pi + CD", 100, 0, 5, 100, 0, 1.2);
    TH2D * pid_kplus_fd_debug = new
    TH2D("pid_kplus_fd_debug", "PID Cut K+ FD", 100, 0, 5, 100, 0, 1.2);
    TH2D * pid_kplus_cd_debug = new
    TH2D("pid_kplus_cd_debug", "PID Cut K+ CD", 100, 0, 5, 100, 0, 1.2);

    TH2D * pid_piminus_fd_debug = new
    TH2D("pid_piminus_fd_debug", "PID Cut #pi + FD", 100, 0, 5, 100, 0, 1.2);
    TH2D * pid_piminus_cd_debug = new
    TH2D("pid_piminus_cd_debug", "PID Cut #pi + CD", 100, 0, 5, 100, 0, 1.2);
    TH2D * pid_kminus_fd_debug = new
    TH2D("pid_kminus_fd_debug", "PID Cut K+ FD", 100, 0, 5, 100, 0, 1.2);
    TH2D * pid_kminus_cd_debug = new
    TH2D("pid_kminus_cd_debug", "PID Cut K+ CD", 100, 0, 5, 100, 0, 1.2);
    TH2D * pid_neutrals_fd_debug = new
    TH2D("pid_neutrals_fd_debug", "PID Cut neutrals FD", 100, 0, 5, 100, 0, 1.2);
    TH2D * pid_neutrals_cd_debug = new
    TH2D("pid_neutrals_cd_debug", "PID Cut neutrals CD", 100, 0, 5, 100, 0, 1.2);
    TH2D * pid_deuteron_fd_debug = new
    TH2D("pid_deuteron_fd_debug", "PID Cut deuteron FD", 100, 0, 5, 100, 0, 1.2);
    TH2D * pid_deuteron_cd_debug = new
    TH2D("pid_deuteron_cd_debug", "PID Cut deutereon CD", 100, 0, 5, 100, 0, 1.2);

    TH1D * el_vz_debug = new
    TH1D("el_vz_debug", "El vertex ", 100, -20, 10);
    TH1D * el_vz_p_debug = new
    TH1D("el_vz_p_debug", "El-proton vertex ", 100, -10, 10);
    ...
    TH2D * multi_p_vs_cpi_BC_debug = new
    ...
    TH1D * multi_p_BC_debug = new
    TH1D("multi_p_BC_debug", "#font[12]{#p} BC (no #e cuts, CD & FD);#font[12]{#p}", 10, 0, 10);
    ...
    TH1D * multi_cpi_BC_debug = new
    TH1D("multi_cpi_BC_debug", "#font[12]{##pi^{#pm}} BC (no #e cuts, CD & FD);#font[12]{##pi^{#pm}}", 10, 0, 10);
    //</editor-fold>
    ...
    TH2D * multi_p_vs_cpi_AC_debug = new
    ...
    TH1D * multi_p_AC_debug = new
    TH1D("multi_p_AC_debug", "#font[12]{#p} AC (no #e cuts, CD & FD);#font[12]{#p}", 10, 0, 10);
    ...
    TH1D * multi_cpi_AC_debug = new
    TH1D("multi_cpi_AC_debug", "#font[12]{##pi^{#pm}} AC (no #e cuts, CD & FD);#font[12]{##pi^{#pm}}", 10, 0, 10);
    //</editor-fold>
    ...
    //                                                       10, 0, 10, 10, 0, 10);
    TH2D * multi_p_vs_cpi_1e_cut_BC_debug = new
    ...
    TH1D * multi_p_1e_cut_BC_debug = new
    TH1D("multi_p_1e_cut_BC_debug", "#font[12]{#p} BC (1e cut, CD & FD);#font[12]{#p}", 10, 0, 10);
    ...
    TH1D * multi_cpi_1e_cut_BC_debug = new
    TH1D("multi_cpi_1e_cut_BC_debug", "#font[12]{##pi^{#pm}} BC (1e cut, CD & FD);#font[12]{##pi^{#pm}}", 10, 0, 10);
    //</editor-fold>
    ...
    //                                                       10, 0, 10, 10, 0, 10);
    TH2D * multi_p_vs_cpi_1e_cut_AC_debug = new
    ...
    TH1D * multi_p_1e_cut_AC_debug = new
    TH1D("multi_p_1e_cut_AC_debug", "#font[12]{#p} AC (1e cut, CD & FD);#font[12]{#p}", 10, 0, 10);
    ...
    TH1D * multi_cpi_1e_cut_AC_debug = new
    TH1D("multi_cpi_1e_cut_AC_debug", "#font[12]{##pi^{#pm}} AC (1e cut, CD & FD);#font[12]{##pi^{#pm}}", 10, 0, 10);
    //</editor-fold>
    ...
    TH2D * hTheta_e_vs_Phi_e_fiducial_cuts_map_ECAL = new
    TH2D("Electron_fiducial_cuts_map_ECAL", "#theta_{e} vs. #phi_{e};#phi_{e} [Deg];#theta_{e} [Deg]",
         250, -180, 180, 250, 0, 50); // My addition

    TH2D * hTheta_p_vs_Phi_p_AMap_DC_NO_CUTS = new
    TH2D("Proton_AMap_DC_NO_CUTS", "#theta_{p} vs. #phi_{p} - NO DC edge cuts;#phi_{p} [Deg];#theta_{p} [Deg]",
         250, -180, 180, 250, 0, 50); // My addition
    TH2D * hTheta_p_vs_Phi_p_AMap_DC_WITH_CUTS = new
    TH2D("Proton_AMap_DC_WITH_CUTS", "#theta_{p} vs. #phi_{p} - WITH DC edge cuts;#phi_{p} [Deg];#theta_{p} [Deg]",
         150, -180, 180, 150, 0, 50); // My addition

    TH2D * hTheta_vs_Phi_hit_map_ECAL_no_fiducial_cuts = new
    TH2D("hit_map_ECAL_no_fiducial_cuts", "ECAL #theta vs. #phi - no fiducial cuts;#phi [Deg];#theta [Deg]",
         250, -180, 180, 250, 0, 50); // My addition
    TH2D * hTheta_vs_Phi_hit_map_ECAL_w_fiducial_cuts = new
    TH2D("hit_map_ECAL_w_fiducial_cuts", "ECAL #theta vs. #phi - with fiducial cuts;#phi [Deg];#theta [Deg]",
         250, -180, 180, 250, 0, 50); // My addition
    //</editor-fold>

    TH2D * hAng_hit_map_electrons = new
    TH2D("Electron_AMap", "Electron hit map with ECAL & DC fiducial cuts;#phi [Deg];#theta [Deg]",
         250, -180, 180, 250, 0, 50); // My addition
    TH2D * hAng_hit_map_protons = new
    TH2D("Protons_hit_map", "Protons hit map with DC fiducial cuts;#phi [Deg];#theta [Deg]",
         250, -180, 180, 250, 0, 50); // My addition
    TH2D * hAng_hit_map_neutrons = new
    TH2D("Neutrons_hit_map", "Neutrons hit map (no fiducial cuts);#phi [Deg];#theta [Deg]",
         250, -180, 180, 250, 0, 50); // My addition
    //</editor-fold>
...
void clas12ana::Init() {
    for (int i = 0; i < 7; i++) {
        ecal_sf_fcn[0][i] = new
        TF1(Form("ecal_sf_fcn_0_%d", i), "[0] + [1]/x + [2]/pow(x,2) - [6]*( [3] + [4]/x + [5]/pow(x,2))", 0, 1.5);
        ecal_sf_fcn[1][i] = new
        TF1(Form("ecal_sf_fcn_1_%d", i), "[0] + [1]/x + [2]/pow(x,2) + [6]*( [3] + [4]/x + [5]/pow(x,2))", 0, 1.5);

        ecal_p_fcn[0][i] = new
        TF1(Form("ecal_p_fcn_0_%d", i), "[0] + [1]/x + [2]/pow(x,2) - [6]*( [3] + [4]/x + [5]/pow(x,2))", 0, 10);
        ecal_p_fcn[1][i] = new
        TF1(Form("ecal_p_fcn_1_%d", i), "[0] + [1]/x + [2]/pow(x,2) + [6]*( [3] + [4]/x + [5]/pow(x,2))", 0, 10);
    }
...
bool clas12ana::checkVertexCorrelation(region_part_ptr el, region_part_ptr p) {
    ...
    if (p->getRegion() == FD) {
        // My addition!
        return ((p->par()->getVz() - el->par()->getVz()) > vertex_corr_cuts_FD.at(0) && (p->par()->getVz() - el->par()->getVz()) < vertex_corr_cuts_FD
                .at(1));
    } else if (p->getRegion() == CD) {
        return ((p->par()->getVz() - el->par()->getVz()) > vertex_corr_cuts_CD.at(0) && (p->par()->getVz() - el->par()->getVz()) < vertex_corr_cuts_CD
                .at(1));
    } else {
        return ((p->par()->getVz() - el->par()->getVz()) > vertex_corr_cuts.at(0) && (p->par()->getVz() - el->par()->getVz()) < vertex_corr_cuts.
                at(1));
    }
...
void clas12ana::InitDebugPlots() {
    for (int i = 1; i <= 6; i++) {
        sf_p_debug_b[i] = new
        TH2D(Form("sf_p_debug_b_sector_%d", i), Form("Sampling Fraction Before Cuts Sector_%d", i), 100, 0, 6, 100, 0, .4);
        sf_p_debug_a[i] = new
        TH2D(Form("sf_p_debug_a_sector_%d", i), Form("Sampling Fraction  After Cuts Sector_%d", i), 100, 0, 6, 100, 0, .4);

        sf_e_debug_b[i] = new
        TH2D(Form("sf_e_debug_b_sector_%d", i), Form("Sampling Fraction Before Cuts Sector_%d", i), 100, 0, 1.5, 100, 0, .4);
        sf_e_debug_a[i] = new
        TH2D(Form("sf_e_debug_a_sector_%d", i), Form("Sampling Fraction  After Cuts Sector_%d", i), 100, 0, 1.5, 100, 0, .4);
    }

    // DC hit maps
    for (int i = 1; i <= 3; i++) {
        dc_hit_map_b[i] = new
        TH2D(Form("dc_hitmap_before_%d", i), Form("Region %d Before Cuts", i), 600, -300, 300, 600, -300, 300);
        dc_hit_map_a[i] = new
        TH2D(Form("dc_hitmap_after_%d", i), Form("Region %d After Cuts", i), 600, -300, 300, 600, -300, 300);
        dc_hit_map_a_proton[i] = new
        TH2D(Form("dc_hitmap_after_proton_%d", i), Form("Region %d After Cuts", i), 600, -300, 300, 600, -300, 300);
        dc_hit_map_b_proton[i] = new
        TH2D(Form("dc_hitmap_before_proton_%d", i), Form("Region %d Before Cuts", i), 600, -300, 300, 600, -300, 300);
        dc_hit_map_a_pion[i] = new
        TH2D(Form("dc_hitmap_after_pion_%d", i), Form("Region %d After Cuts", i), 600, -300, 300, 600, -300, 300);
        dc_hit_map_b_pion[i] = new
        TH2D(Form("dc_hitmap_before_pion_%d", i), Form("Region %d Before Cuts", i), 600, -300, 300, 600, -300, 300);
    }
}

void clas12ana::WriteDebugPlots() {
    TFile * f_debugOut = new
    TFile(debug_fileName, "RECREATE");
    ...
    TFile * hit_map_ref_Out = new
    TFile(hit_map_ref_Out_filename, "RECREATE");

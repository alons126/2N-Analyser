...
private:
    ...
    string Global_Run_Status = "ChainRunV7_R3_old";
    // string Global_Run_Status = "ChainRunV7_R3_1n_inEvent";
    // string Global_Run_Status = "ChainRunV7_R3_1n_inEvent_Matched_33";
...
public:
    ...
    void ConfigureStatuses(const bool &apply_cuts, const bool &clas12ana_particles, const bool &only_preselection_cuts,
                           ...
                           const bool &apply_kinematical_cuts, const bool &apply_kinematical_weights, const bool &apply_fiducial_cuts,
                           const bool &Generate_AMaps,
                           const bool &plot_and_fit_MomRes, const bool &VaryingDelta, const bool &Calculate_momResS2, const bool &Run_in_momResS2,
                           const bool &nRes_test,
                           const bool &Rec_wTL_ES, const bool &ZoomIn_On_mom_th_plots);

    // SetPaths function -----------------------------------------------------------------------------------------------------------------------------------------------

    void SetPaths(const string &WorkingDirectory, const string &SampleName, const string &plots_path, const bool &apply_cuts,
                  const bool &apply_chi2_cuts_1e_cut,
    ...
    bool GetCustomCutsNaming() {
        return Custom_cuts_naming;
    }
    ...
    string GetPreselection_Cuts_Status() {
        return Preselection_Cuts_Status;
    }
    ...
    string GetNucleon_Cuts_Status() {
        return Nucleon_Cuts_Status;
    }

    string GetFD_photons_Status() {
        return FD_photons_Status;
    }

    string GetPSmearing_Status() {
        return PSmearing_Status;
    }

    string GetFiducialCuts_Status() {
        return FiducialCuts_Status;
    }

    string GetKinWei_Status() {
        return KinWei_Status;
    }

    string GetAdditional_Status() {
        return Additional_Status;
    }

    string GetEfficiency_Status() {

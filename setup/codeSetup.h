...
void ConfigSampleChain()
{
    ...
    // /* G18 Q2 4GeV */
    // Config_G18_4GeV_Q2_test_samples(AnalyseFilePath_v, AnalyseFileSample_v, AnalyseFileDir_v, AnalyseFile_v, AnalyseFilePath, AnalyseFileSample, AnalyseFileDir, AnalyseFile);

    // /* SuSa Q2 4GeV */
    // Config_SuSa_4GeV_Q2_test_samples(AnalyseFilePath_v, AnalyseFileSample_v, AnalyseFileDir_v, AnalyseFile_v, AnalyseFilePath, AnalyseFileSample, AnalyseFileDir, AnalyseFile);
